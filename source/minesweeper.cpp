...
// ANS Meletakan bomb secara random sebanyak bomb_qty
...
// What does this function do?
// ANS Menambah value setiap sel di sekitar bomb
...
// What does this function do?
// ANS Menandai dan menghitung jumlah sel yang sudah dibuka, ketika nilainya 0 akan dicek sel sekitarnya
// Ketika nilainya bomb maka selesai
...
int main()
{
  ...
  // ANS Jika jumlah bomb lebih banyak dari jumlah sel, akan terjadi looping
  do
  {
  ...
  // What does do-while below do?
  // ANS jika game_state masih PLAYING maka akan terjadi looping
  do
  {
    printMap(map, N);
